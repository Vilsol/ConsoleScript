...
public class Utils {
	...
	public static List<String> functionalCommands = Arrays.asList("delay", "run", "stopscript", "while", "wait", "setblock", "set", "setl", "region", "dropitem", "world", "spawnmob", "setregionblocks");
